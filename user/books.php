      ...
      <div class="col-lg-3 leftbox">
        ...
        <div class="paging col-sm-7">
            <?php 
                ...
                if($page>1)
                {
                    echo "<a href='books.php?page=".($page-1)."' class='btn btn-success'>Previous</a>";
                }

                
                for($i=1;$i<=$total_page;$i++)
                {
                    echo "<a  href=books.php?page=".$i."' class='btn btn-primary'>$i</a>";
                }

                if($i>$page)
                {
                    echo "<a href='books.php?page=".($page+1)."' class='btn btn-danger'>Next</a>";
                }
