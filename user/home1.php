    ...
    <div class="navbar-collapse collapse">
      <ul class="nav home navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li class="dropdown-submenu">
              <li><a tabindex="-1" href="client_log/cl_log.php">Login/Signup</a></li>
              <li><a target="_blank" tabindex="-1" href="../admin_panel/login_system/index.php">Admin Login</a></li>
            </li>                     
          </ul>               
        </li>
  ...
  <div class="container">
    ...
    <div class="catshow col-lg-11">
      ...
      <div class="col-lg-3 col-sm-3">
        ...
        <a href="books.php"><img src="img/book.png" style="height:160px; width:195px; margin-left:50px;"></a>
      </div>
      </div>
            ...
            <?php 
              ...
              ?>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                  <div class="lat">
                      <img src="logedin/upload/<?php echo $row[4]?>" style="height:30%; width:100%;"><br><br>
   ...
   <div class="container">
    ...
    <div class="catshow col-lg-11">
      ...
      <div class="col-lg-3 col-sm-3">
        ...
        <a href="book.php"><img src="games.png" style="height:140px; width:190px; margin-top:30%;margin-left:5%;"></a>
      </div>
      </div>
<div class="col-lg-3 col-sm-5">
        <div class="well wella"><h3>Fitness Needs</h3>
        <a href="vehicle.php"><img src="fitness.png" style="height:130px; width:210px; margin-top:20%;"></a>
      </div>
      </div>
<div class="col-lg-3 col-sm-5">
        <div class="well wella"><h3>Others</h3>
        <a href="gaming.php"><img src="others.png" style="height:130px; width:200px; margin-top:20%;"></a>
      </div>
      </div>
