      ...
      <div class="rightbox col-sm-10  col-lg-9">
                ...
                <div class="col-lg-4 col-md-6 col-sm-10">
                  <div class="lat">
                      ...
                      <div class="lat2">
                        ...
                        <a href="practice1.php?id=<?php echo $row['id'] ?>"><button class="custom-btn btn-6"><span>View Product</span></button></a>
        ...
        <div class="paging col-sm-7">
            <?php 
                ...
                $pr_query = "SELECT * FROM products WHERE Category='electronics' ";
