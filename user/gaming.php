<?php 
  ...
  $sql="SELECT* FROM cl_addl where category='Gaming' AND status='approved' order by id desc limit $start_from,$num_per_page";
      ...
      <div class="col-lg-3 leftbox">
        ...
        <div class="paging col-sm-7">
            <?php 
                ...
                $pr_query = "SELECT * FROM cl_addl WHERE Category='gaming' AND status='approved' ";
