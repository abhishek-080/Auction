<?php 
  ...
  $sql="SELECT* FROM cl_addl where category='others' AND status='approved' order by id desc limit $start_from,$num_per_page";
      ...
      <div class="col-lg-3 leftbox">
        ...
        <div class="paging col-sm-7">
            <?php 
                ...
                $pr_query = "SELECT * FROM cl_addl WHERE Category='others' AND status='approved' ";
                ...
                if($page>1)
                {
                    echo "<a href='others.php?page=".($page-1)."' class='btn btn-success'>Previous</a>";
                }

                
                for($i=1;$i<=$total_page;$i++)
                {
                    echo "<a  href=others.php?page=".$i."' class='btn btn-primary'>$i</a>";
                }

                if($i>$page)
                {
                    echo "<a href='others.php?page=".($page+1)."' class='btn btn-danger'>Next</a>";
                }
