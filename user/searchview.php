      ...
      <div class="rightbox col-sm-10  col-lg-9">
            ...
            <?php 
                ...
                if (isset($_POST['search'])) {
                   ...
                   $str= preg_replace("#[^0-9a-z]#i", "", $str);
                    ...
                    $sql="SELECT * FROM cl_addl WHERE (name LIKE'%$str%')OR (category LIKE '%$str%') limit $start_from,$num_per_page" or die("could not search");
        ...
        <div class="paging col-sm-7">
            <?php 
                ...
                $pr_query = "SELECT * FROM cl_addl where category='others' ";
                ...
                if($page>1)
                {
                    echo "<a href='searchview.php?page=".($page-1)."' class='btn btn-success'>Previous</a>";
                }

                
                for($i=1;$i<=$total_page;$i++)
                {
                    echo "<a  href='searchview.php?page=".$i."' class='btn btn-primary'>$i</a>";
                }

                if($i>$page)
                {
                    echo "<a href='searchview.php?page=".($page+1)."' class='btn btn-danger'>Next</a>";
                }
