<?php 
  ...
  $sql="SELECT* FROM cl_addl where category='electronics' AND status='approved' order by id desc limit $start_from,$num_per_page";
      ...
      <div class="rightbox col-sm-10  col-lg-9">
        ...
        <div class="paging col-sm-7"> 
            <?php 
                ...
                if($page>1)
                {
                    echo "<a href='electronics.php?page=".($page-1)."' class='btn btn-success'>Previous</a>";
                }

                
                for($i=1;$i<=$total_page;$i++)
                {
                    echo "<a  href='electronics.php?page=".$i."' class='btn btn-primary'>$i</a>";
                }

                if($i>$page)
                {
                    echo "<a href='electronics.php?page=".($page+1)."' class='btn btn-danger'>Next</a>";
                }
