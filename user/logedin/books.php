<?php 
 session_start();
  ...
  $sql="SELECT* FROM cl_addl where category='books' And status='approved' order by id desc limit $start_from,$num_per_page";
      ...
      <div class="rightbox col-sm-10  col-lg-9">
        ...
        <div class="paging col-sm-7">
            <?php 
                ...
                if($page>1)
                {
                    echo "<a href='books.php?page=".($page-1)."' class='btn btn-success'><span class='glyphicon glyphicon-chevron-left'></span></a>";
                }

                
                for($i=1;$i<=$total_page;$i++)
                {
                    echo "<a  href='books.php?page=".$i."' class='btn btn-primary active'>$i</a>";
                }

                if($i>$page)
                {
                    echo "<a href='books.php?page=".($page+1)."' class='btn btn-danger'><span class='glyphicon glyphicon-chevron-right'></a>";
                }
