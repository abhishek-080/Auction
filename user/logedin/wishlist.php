<?php 
 ...
 if(isset($_GET['delete_id'])){
        $sql = "DELETE FROM wishlist WHERE id =".$_GET['delete_id'];
      ...
      <div class="rightbox col-sm-10  col-lg-9">
        ...
        <script type="text/javascript">
          ...
          <div class="items ">
            ...
            <?php 
              ...
              $sql="SELECT w.*, p.name pn, p.image pi, p.edate pe FROM wishlist w, cl_addl p where p.id=w.pid AND w.u_id='$_SESSION[u_id]' limit $start_from,$num_per_page ";
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                  <div class="lat">
                      ...
                      <div class="lat2">
                        ...
                        <a href="javascript:delete_id(<?php echo $row[0]?>)"><button class="custom-btn btn-6">Remove</button></a></td>
        ...
        <div class="paging col-sm-7">
            <?php 
                ...
                $pr_query = "SELECT * FROM wishlist where u_id='$_SESSION[u_id]'";
                ...
                if($page>1)
                {
                    echo "<a href='wishlist.php?page=".($page-1)."' class='btn btn-success'><span class='glyphicon glyphicon-chevron-left'></span></a>";
                }

                
                for($i=1;$i<=$total_page;$i++)
                {
                    echo "<a  href='wishlist.php?page=".$i."' class='btn btn-primary active'>$i</a>";
                }

                if($i>$page)
                {
                    echo "<a href='wishlist.php?page=".($page+1)."' class='btn btn-danger'><span class='glyphicon glyphicon-chevron-right'></a>";
                }
