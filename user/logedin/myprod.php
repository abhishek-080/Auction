<?php 
 session_start();
  ...
  $sql="SELECT* FROM cl_addl where u_id=$_SESSION[u_id] ";
    ...
    <div class="box">
      ...
      <div class="rightbox col-sm-10  col-lg-9">
        ...
        <div class="col-lg-12">               
          ...
          <div class="col-sm-12  dropdown sort  text-right">
              <button class="btn btn-danger dropdown-toggle"  type="button" data-toggle="dropdown" >Deafult Sorting</button>
        ...
        <div class="paging col-sm-7">
            <?php 
                ...
                $pr_query = "SELECT * FROM cl_addl where u_id=$_SESSION[u_id]";
                ...
                if($page>1)
                {
                    echo "<a href='myprod.php?page=".($page-1)."' class='btn btn-success'><span class='glyphicon glyphicon-chevron-left'></span></a>";
                }

                
                for($i=1;$i<=$total_page;$i++)
                {
                    echo "<a  href='myprod.php?page=".$i."' class='btn btn-primary active'>$i</a>";
                }

                if($i>$page)
                {
                    echo "<a href='myprod.php?page=".($page+1)."' class='btn btn-danger'><span class='glyphicon glyphicon-chevron-right'></a>";
                }
