        ...
        <div class="col-lg-12">               
          ...
          <div class="items ">
            ...
            <?php 
              ...
              $sql="SELECT w.*, p.name pn, p.image pi, p.edate pe FROM wishlist w, cl_addl p where p.id=w.pid AND u_id=$_SESSION[u_id] ";
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                  <div class="lat">
                      ...
                      <div class="lat2">
                        ...
                        <a href="#"><button class="custom-btn btn-6"><span>Delete Product</span></button></a>
