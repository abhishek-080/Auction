<?php 
    ...
    $sql="SELECT * FROM cl_addl where status='pending' order by id desc limit $start_from,$num_per_page";
...
<body>
    ...
    <div class="paging">
     <?php 
                ...
                $pr_query = "SELECT * from cl_addl WHERE status='pending' ";
